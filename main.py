...
##########################
token = 'MTI0Mzk4MjcyNTk2NzM4MDUzMA.G8xy_Q.fM8U68MKD2RHKxXlLVprSeiEUT72q_MzqTImfE'
YOUR_USER_ID = 1099312762242473994
#########################
...
async def shutdown(ctx):
    # Check if the user invoking the command is the owner (you)
...
async def clear(ctx, amount=5):
        ...
        Embed = discord.Embed(title='✅ sucsess!', timestamp=ctx.message.created_at,description=f'{ctx.author.mention} Deleted {amount} messages!', color=0x00ff00)
